...
from concentration_loss import calculate_concentration_loss, calculate_concentration_loss_syngen

logger = logging.get_logger(__name__)

class AttendAndExciteConcentPipeline(StableDiffusionPipeline):
    r"""
            ...
            for i, t in enumerate(timesteps):
                ...
                with torch.enable_grad():
                    ...
                    if not run_standard_sd:
                        ...
                        for pair in [[2, 3], [6, 7]]:
                            noun, modifier = pair
                            con_loss.append(calculate_concentration_loss_syngen(attention_maps_list, noun, modifier))
